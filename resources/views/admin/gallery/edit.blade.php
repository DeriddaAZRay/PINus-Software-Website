            ...
            <header class="bg-white shadow-sm border-b border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update your gallery image information</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex items-center">
                            ...
                            <h2 class="text-lg font-semibold text-gray-800">Update Image Details</h2>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input 
                                        ...
                                        value="{{ old('cJudul', $gallery->cJudul) }}"
                                        required
                                    >
                                </div>
                            </div>
