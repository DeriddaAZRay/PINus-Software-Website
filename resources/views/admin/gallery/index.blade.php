                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($galleries as $gallery)
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center">
                                                    <div class="h-16 w-20 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 flex-shrink-0">
                                                        @if($gallery->cFoto)
                                                            <img 
                                                            ...
                                                            >
                                                        @endif
                                                        <div class="h-full w-full items-center justify-center {{ $gallery->cFoto ? 'hidden' : 'flex' }}">
