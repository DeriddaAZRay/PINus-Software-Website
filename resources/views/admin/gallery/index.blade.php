        ...
        <div class="flex-1 flex flex-col md:ml-64 w-full">
            ...
            <header class="bg-white shadow-sm border-b border-gray-100 p-4 md:p-6">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">Gallery Management</h1>
                        <p class="text-sm md:text-base text-gray-600 mt-1">Manage your photo gallery and images</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="text-right">
                            <p class="text-sm text-gray-500">Total Images</p>
                            <p class="text-sm font-medium text-gray-800">{{ count($galleries) }}</p>
                        </div>
            ...
            <main class="flex-1 p-6">
                ...
                <!-- Action Bar for Gallery -->
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Gallery Images</h2>
                    <a 
                        href="{{ route('admin.gallery.create') }}" 
                        class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-4 focus:ring-purple-300 flex items-center shadow-md"
                    >
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center">
                                ...
                                <h2 class="text-lg font-semibold text-gray-800">All Gallery Images</h2>
                            </div>
                            <div class="text-sm text-gray-500">
                                {{ count($galleries) }} images total
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center">
                                                    ...
                                                    <div class="w-16 bg-gray-100 border border-gray-200 rounded-lg overflow-hidden flex-shrink-0" style="aspect-ratio: 4/5;">
                                                        @if($gallery->cFoto)
                                                            <img 
                                                            ...
                                                            >
                                                        @endif
                                                        <div class="w-full h-full items-center justify-center {{ $gallery->cFoto ? 'hidden' : 'flex' }}">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">
                                                {{ $gallery->dTgl_Input?->format('d/m/Y') ?: '-' }}
                                            </td>
                                            <td class="px-6 py-4">
                                                <div class="flex flex-wrap items-center gap-2">
                                                    ...
                                                    <form action="{{ route('admin.gallery.destroy', $gallery->ID) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this image? This action cannot be undone.')" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button 
                                                            type="submit" 
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-gray-500 mb-4">Get started by adding your first gallery image.</p>
                                                    <a 
                                                        href="{{ route('admin.gallery.create') }}" 
                                                        class="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center"
                                                    >
