        ...
        <div class="flex-1 flex flex-col md:ml-64 w-full">
            ...
            <header class="bg-white shadow-sm border-b border-gray-100 p-4 md:p-6">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        <h1 class="text-xl md:text-2xl font-bold text-gray-800">Video Gallery Management</h1>
                        <p class="text-sm md:text-base text-gray-600 mt-1">Manage your video content and testimonials</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="text-right">
                            <p class="text-sm text-gray-500">Total Videos</p>
                            <p class="text-sm font-medium text-gray-800">{{ count($videos) }}</p>
                        </div>
                    ...
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center">
                                ...
                                <h2 class="text-lg font-semibold text-gray-800">All Videos</h2>
                            </div>
                            <div class="text-sm text-gray-500">
                                {{ count($videos) }} videos total
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse ($videos as $video)
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center">
                                                    <div class="h-12 w-20 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 flex-shrink-0">
                                                        @if($video->cLink)
                                                            <img 
                                                            ...
                                                            >
                                                        @endif
                                                        <div class="h-full w-full items-center justify-center {{ $video->cLink ? 'hidden' : 'flex' }}">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900 max-w-xs truncate">
                                                    {{ Str::limit($video->cDeskripsi, 100) }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                                @if($video->cJenis == 't')
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex flex-wrap items-center gap-2">
                                                    ...
                                                    <form action="{{ route('admin.videos.destroy', $video->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this video? This action cannot be undone.')" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button 
                                                            type="submit" 
                                        ...
                                        <tr>
                                            <td colspan="7" class="px-6 py-12 text-center">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-gray-500 mb-4">Get started by adding your first video.</p>
                                                    <a 
                                                        href="{{ route('admin.videos.create') }}" 
