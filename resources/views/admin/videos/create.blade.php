        ...
        <div class="flex-1 flex flex-col ml-64">
            ...
            <header class="bg-white shadow-sm border-b border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Add New Video</h1>
                        <p class="text-gray-600 mt-1">Add a new video to your gallery</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex items-center">
                            ...
                            <h2 class="text-lg font-semibold text-gray-800">Video Details</h2>
                        </div>
                    </div>
