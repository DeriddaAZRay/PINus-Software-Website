            ...
            <div class="relative z-10 bg-gradient-to-b md:bg-gradient-to-r from-white/80 md:from-white/60 via-white/70 md:via-white/40 to-white/60 md:to-white/20 backdrop-blur-sm">
                    ...
                    <div class="container mx-auto relative z-10">
                        <div class="flex items-center justify-center mb-4 relative">
                            <div class="text-center">
                                <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Logo Transition Announcement</h1>
                ...
                <div class="px-6 py-6 md:px-6 md:py-6">
                    <div class="max-w-4xl mx-auto space-y-6">
                        ...
                        <!-- Logo Transitions -->
                        <div class="px-4 md:px-16 space-y-8">
                            <!-- Company Logo Transition -->
                            <div class="bg-white/70 backdrop-blur-sm rounded-lg p-6 shadow-md">
                                <h3 class="text-xl font-semibold mb-4 text-gray-800 text-center">Company Logo Evolution</h3>
                            ...
                            <div class="bg-white/70 backdrop-blur-sm rounded-lg p-6 shadow-md">
                                <h3 class="text-xl font-semibold mb-4 text-gray-800 text-center">Product Logo Evolution</h3>
                                <div class="flex items-center justify-center space-x-6 md:space-x-12">
                                    <!-- Old Product Logo -->
                                    <div class="text-center">
